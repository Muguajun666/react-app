...
const BottomSheetComponent = forwardRef<BottomSheet, BottomSheetProps>((props, ref) => {
	const {onLock, closeHandle } = props
	...
	return (
		...
		>
			<BottomSheetView style={styles.contentContainer}>
				<Pressable onPress={() => onLock && onLock()} style={[styles.buttonContainer, {marginTop: 10}]}>
					<Image
						source={require('../../../../assets/images/buttonBg.png')}
						style={{ width: '100%', height: '100%', position: 'absolute', borderRadius: 8 }}
					/>
					<Text style={{ fontSize: 16, fontWeight: 400, color: '#9605EC' }}>Lock/UnLock</Text>
				</Pressable>
